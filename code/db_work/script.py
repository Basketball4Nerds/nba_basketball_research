...
## get a list of season slugs
seasons = [str(season) + "-" + str(season+1)[2:4] for season in range(2006, 2018)]
seasons

## get team details df (useless)
# team_details_df = nba_py.team.TeamDetails(team_id=1610612752)
...
# get team summary and append to df
for team_id in team_ids: 
    for season in seasons:
        df = nba_py.team.TeamSummary(team_id=team_id, 
                                    season=season,
                                    league_id='00',
